<nav x-data="{ open: false }" class="bg-white/30 sticky top-0 z-10 backdrop-filter backdrop-blur-xl dark:bg-gray-800/30 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                {{-- <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ Auth::user()->email }}
            </div>
