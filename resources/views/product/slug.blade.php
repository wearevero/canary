      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <form method="post" action="{{  route('products.store') }}" enctype="multipart/form-data" class="py-5 text-lg items-center justify-center">
            ...
            <div class="mb-6 flex">
              <span class="inline-flex items-center dark:text-slate-100 px-3 text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                No. Item
              </span>
            ...
            <div class="grid gap-6 md:grid-cols-2">
              <div class="flex">
                ...
                <input disabled type="text" value="{{ $product->main_category->nama_category }}" class="cursor-not-allowed uppercase rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="666" />
              </div>
              <div class="flex">
                <span class="inline-flex items-center px-3 text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-slate-100 dark:border-gray-600">
                  Sub Category
                </span>
                <input disabled type="text" value="{{ $product->category->nama_kategori }}" class="cursor-not-allowed uppercase rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="666" />
              </div>
            </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div class="flex">
                <span class="inline-flex items-center px-3 dark:text-slate-100 text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                  Size Stone
                </span>
                <input disabled type="text" name="size_stone" class="cursor-not-allowed rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" @if ($product->size_stone != null )
