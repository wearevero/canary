              ...
              <div class="p-6 text-gray-900 dark:text-gray-100">
                  ...
                  {{-- testing input group --}}
                      <form method="post" action="{{  route('products.store') }}" enctype="multipart/form-data" class="py-5 disabled text-lg items-center justify-center">
                          @csrf
                          <img src="{{ asset('image/'.$product->image ?? 'tidak ada gambar')}}" alt="{{ $product->no_item }} tidak memiliki gambar" height="250" width="250" class="mx-auto hover:cursor-pointer rounded-md"/>
